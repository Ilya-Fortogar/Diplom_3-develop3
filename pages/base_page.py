...
class BasePage:
    ...
    def click_problem_element(self, locator, timeout=20):
    ...
    def text_attribute(self, locator, text, timeout=20):
        return WebDriverWait(self.driver, timeout).until(expected_conditions.text_to_be_present_in_element_attribute(locator, 'class', text))
